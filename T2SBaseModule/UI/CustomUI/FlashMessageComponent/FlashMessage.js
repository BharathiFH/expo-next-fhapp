...
import { TouchableWithoutFeedback, Platform, StatusBar, Animated, Image, Text, View } from 'react-native';
...
import styles from '../../../../CustomerApp/View/Style/FlashMessageStyles';
/**
                ...
                <View
                    style={styleWithInset(
                        [
                            ...
                            style,
                            styles.defaultFlashBorderRadius,
                            {
                                alignItems: 'center',
                                borderColor: message.borderColor || message.backgroundColor,
                                borderWidth: 1
                            }
                        ],
                        wrapperInset,
                    ...
                    <View style={styles.flashLabel}>
                        <T2SText
                            ...
                            style={[
                                ...
                                !!message.color && { color: message.textColor },
                                titleStyle
                            ]}
                            {...titleProps}>
                            {message.message}
...
export default class FlashMessage extends Component {
    ...
    render() {
        ...
        const containerStyle = this.prop(message, 'containerStyle');
