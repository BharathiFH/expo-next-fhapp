...
import { View, TextInput, Animated, StyleSheet, Platform, I18nManager } from 'react-native';
...
export default class TextField extends PureComponent {
    ...
    constructor(props) {
        ...
        let { value, error, fontSize, prefix, defaultOpen } = props;
        ...
        this.state = {
            ...
            height: fontSize * 1.5,
            showAffix: prefix && (value || defaultOpen)
        };
    }
    ...
    value() {
        ...
        return receivedFocus || value != null || defaultValue == null ? text : defaultValue;
    }
    ...
    onFocus(event) {
        let { onFocus, clearTextOnFocus, prefix } = this.props;
    ...
    onChangeText(text) {
        let { onChangeText, id } = this.props;
        this.setState({ text });
    ...
    render() {
        ...
        let active = !!(value || props.placeholder || defaultOpen);
        ...
        let inputContainerStyle = {
            ...
            ...(props.multiline
                ...
                : { height: labelHeight + inputContainerPadding + fontSize * 1.5 + (text === '' && !focused ? 3 : 0) })
        };
            ...
            <View {...containerProps}>
                <Animated.View {...inputContainerProps}>
                    ...
                    <View style={styles.row}>
                        {this.state.showAffix ? this.renderAffix('prefix', active, focused) : null}
                        ...
                        {this.state.showAffix ? this.renderAffix('suffix', active, focused) : null}
                ...
                <Animated.View style={helperContainerStyle}>
                    <View style={styles.flex}>
                        <Helper style={[errorStyle, titleTextStyle]} numberOfLines={errorNumberOfLines}>
                            {error}
                        </Helper>
